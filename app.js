...
function versionHistory(){
  return [
    ...
    {v:'v8',title:'Fire Athlete OS',tag:'legacy',items:['Performance Lab and Athlete Toolkit','Motivation Vault, discipline contracts and bad-day protocol','Plans & Monetization Lab for future paid versions','9000+ food preset direction and 300+ recipe/performance templates']},
    ...
    {v:'v10',title:'Historic Ultimate Athlete OS',tag:'current',items:['V10 Launchpad, AI Coach Studio, Season Roadmap and Exercise Library','Coach Share, Data Doctor, Template Market and Launch HQ','Docs folder, serverless API examples and production structure','Prepared for hosting, Supabase sync tests and future Free/Pro/Elite versions']}
  ];
}
...
/* =========================
   V10 retained Athlete OS expansion
   Legacy feature layer retained inside the v10 build.
========================= */
...
function v8Migrate(){
  ...
  state.planConfig=state.planConfig||{currentPlan:'Personal Free',price:25,notes:'V10 paywall-ready, real payments later via Stripe/serverless.'};
